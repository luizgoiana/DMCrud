...
<div id="contentAll">
	<s:form method="post" id="funcionarioForm" action="salvarOuAtualizarFuncionario">
			<s:textfield name="funcionario.id" readonly="true" label="Código do Funcionário"/>
			...
			<s:select name="funcionario.sexo" list="sexoArray" listValue="descricao" listKey="chave" 
	        	headerKey="" headerValue="Select" value="funcionario.sexo.chave"
		...
		<table class="userTable" cellpadding="5px">
			...
			<s:iterator value="funcionarios" status="funcionarioStatus">
				<tr
	                ...
	                <s:a href="%{deleteURL}" onclick="confirmDialog()">Deletar</s:a>
	                </td>
				</tr>
			</s:iterator>
		</table>
